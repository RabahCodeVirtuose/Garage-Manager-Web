        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu fade-up m-0">
                    ...
                    <a href="404.html" class="dropdown-item active">Page 404</a>
                </div>
            </div>
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <p class="mb-4">Désolé, la page que vous avez cherchée n'existe pas sur notre site web ! Peut-être retourner à notre page d'accueil ou essayer d'utiliser une recherche ?</p>
    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="">Nettoyage de l'aspirateur</a>
            </div>
            <div class="col-lg-3 col-md-6">
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    ...
                    <!--/*** Ce modèle est gratuit tant que vous conservez le lien de crédit de l'auteur du pied de page / le lien d'attribution / le lien de rétrolien. Si vous souhaitez utiliser le modèle sans le lien de crédit de l'auteur du pied de page / le lien d'attribution / le lien de rétrolien, vous pouvez acheter la licence de suppression de crédit sur "https://htmlcodex.com/credit-removal". Merci pour votre soutien. ***/-->
