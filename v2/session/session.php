...
<!-- En-tête de la page fin -->
 ...
 <section id="appointment" class="appointment section-bg">
    <div class="container">
        <div id="contenu" class="mt-5">
            <div class="section-title">
                <h2>CONNEXION</h2>
            </div>
            <br>
            <div class="row justify-content-center"> <!-- Ajoutez cette div pour centrer le formulaire -->
                <form action="session_action.php" method="post" class="col-md-6">
