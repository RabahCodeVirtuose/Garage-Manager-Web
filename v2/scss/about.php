            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="d-flex py-5 px-4">
                    ...
                    <div class="ps-4">
                        ...
                        <p>Notre engagement envers la qualité se traduit par des résultats exceptionnels pour chaque service que nous offrons. Nous nous efforçons continuellement d'atteindre l'excellence et de dépasser les attentes de nos clients.</p>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="d-flex bg-light py-5 px-4">
                    ...
                    <div class="ps-4">
                        ...
                        <p>Nos travailleurs sont des experts dans leur domaine, dotés des compétences et des connaissances nécessaires pour répondre à tous vos besoins en matière de réparation automobile. Ils s'engagent à fournir un service de première qualité et une satisfaction client maximale.</p>
                        <a class="text-secondary border-bottom" href="">En savoir plus</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="d-flex py-5 px-4">
                    ...
                    <div class="ps-4">
                        ...
                        <p>Nous investissons dans des équipements modernes et à la pointe de la technologie pour garantir un service efficace et de qualité. Notre infrastructure technique nous permet de diagnostiquer et de réparer les problèmes de votre véhicule avec précision et fiabilité.</p>
                        <a class="text-secondary border-bottom" href="">En savoir plus</a>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    ...
                    <!--/*** Ce modèle est gratuit tant que vous conservez le lien de crédit/auteur dans le pied de page. Si vous souhaitez utiliser le modèle sans le lien de crédit/auteur dans le pied de page, vous pouvez acheter la licence de suppression du crédit sur "https://htmlcodex.com/credit-removal". Merci pour votre soutien. ***/-->
